...
import Articlescomponent from '../../../src/components/Subcategorycomponent/articlesphotosvideoscomponent';
const Articles = ({initialSubcategoryListingData, categoryName, subcategoryName}) => {
  return(
    <div className="container pt-4 pt-md-0 px-md-2 px-0 mb-5">
       <Articlescomponent initialSubcategoryListingData={initialSubcategoryListingData} categoryName={categoryName} subcategoryName={subcategoryName} type='Articles'/>
    </div>
  );
}
