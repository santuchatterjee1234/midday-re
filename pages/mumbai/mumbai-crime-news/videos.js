...
import Videoscomponent from '../../../src/components/Subcategorycomponent/articlesphotosvideoscomponent';
const Videos = ({initialSubcategoryListingData, categoryName, subcategoryName}) => {
  return(
    <div className="container pt-4 pt-md-0 px-md-2 px-0 mb-5">
       <Videoscomponent initialSubcategoryListingData={initialSubcategoryListingData} categoryName={categoryName} subcategoryName={subcategoryName} type='Videos'/>
    </div>
  );
}
