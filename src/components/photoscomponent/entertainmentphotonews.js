...
function Entertainmentphotonews() {
  return (
    <section id="Entertainmentphotosnews">
            ...
            <div className="d-flex justify-content-between align-items-center pb-md-0 tab-header">
              <div className="left-inner-colm pb-0 mb-2">
                <h2 className="d-md-inline mr-md-3 main-heading">
                  ...
                  <span className="px-2">Entertainment Photo News</span>
                </h2>
              </div>
              <div className="">
                <Link href="">
                    ...
                    <div className="col-6">
                      ...
                      <Link href="">
                        <div className="position-relative">
                          ...
                          <Image
                            src={camera}
                            className="camera-position-small"
                          />
                          <span className="img-story-label-position-category">
                            PM Modi
                          </span>
...
export default Entertainmentphotonews;
