  ...
  return (
    <div className="container mb-3 px-md-3">
      <div className="row">
          ...
          <div className="d-flex justify-content-between align-items-center pb-md-0 tab-header">
            <div className="left-inner-colm pb-0 mb-2 px-md-2">
              <h2 className="d-md-inline mr-md-3 main-heading">
                ...
                <span className="px-md-3 px-2">Sports</span>
              </h2>
            </div>
            <div className="">
              <Link href="/sports">
                  ...
                  <div className="col-md-6 position-relative">
                    ...
                    <div className="row-pos">
                      <div className="row row-height-position">
                        ...
                        <div className="col-3 ps-0 position-relative">
                          <Link href={item.URL}>
                            <img
                              src={item.Images.Image2}
                              alt={item.image_caption}
        ...
        <div className="col-md-3 rhselement pt-1">
          {/* Advertisement Start */}
          <div className="row">
                ...
                <Link href="#">
                  <div className={homecss.borderleft}>
                    <div className="eventTittle d-flex justify-content-between px-2 pt-2">
                      <p className={homecss.eventhead}>{item.SubCategoryName}</p>
                      <p className={homecss.eventfinal}>{item.SubTitle}</p>
                    </div>
