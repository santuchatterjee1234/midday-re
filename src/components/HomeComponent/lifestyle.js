...
function Lifestyle({data}) {
  ...
  return (
    <div className='container mb-md-3 px-md-3'>
      <div className='row'>
        <div className='col-md-9 lhselement category-right-border-desktop ps-md-0'>
          <div className="d-flex justify-content-between align-items-center pb-md-0 tab-header">
            <div className="left-inner-colm pb-0 mb-2 px-md-2">
              <h2 className="d-md-inline mr-md-3 main-heading"><span className='main-headline-sidebar category-side-bar'></span><span className='px-md-3 px-2'>Lifestyle</span></h2>
            </div>
            <div className="">
              <Link href="/lifestyle">
                      ...
                      <div className="col-3 ps-0 mb-3 mb-md-0 position-relative mb-3">
                        <Link href={item.URL}>
                          <img
                            ...
                            alt={item.image_caption}
                            title= {item.Homeheadline}
                            className="pt-md-0 border-radius-img mt-2"
                          />
                          {item.username === 'Videos' && (
                            <Image
                              src={pauseicon}
        ...
        <div className='col-md-3 rhselement pt-2 pt-md-3'>
          ...
          <div className='row'>
            <div className='col-md-12'>
              <p className="advertisement-text text-center mt-1 mt-md-4 mb-0">ADVERTISEMENT</p>
            ...
            <div className='row'>
              <div className="d-flex justify-content-between align-items-center pt-2 pb-2 tab-header">
                <div className="left-inner-colm pb-0 mb-2">
                  <h2 className="d-md-inline mr-md-3 main-heading"><span className='main-headline-sidebar'></span><span className='px-2'>Unsung Heroes</span></h2>
                </div>
                <div className="">
                  <Link href="">
                    <Image src={cta} className='cta-position'/>
      ...
      <div className='row'>
        <div className='col-md-12'>
          <p className="advertisement-text text-center mt-md-3 mb-0">ADVERTISEMENT</p>
          {/* 970*250 Add Start */}
