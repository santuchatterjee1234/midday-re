...
function News({data}) {
  ...
  return (
    <div className='container mb-4 px-md-3'>
      <div className='row'>
        <div className='col-md-9 lhselement category-right-border-desktop ps-md-2'>
          <div className="d-flex justify-content-between align-items-center pb-md-0 tab-header">
            <div className="left-inner-colm pb-0 mb-2 px-md-0">
              <h2 className="d-md-inline mr-md-3 main-heading"><span className='main-headline-sidebar category-side-bar'></span><span className='px-md-3 px-2'>News</span></h2>
            </div>
            <div className="">
              <Link href="/news">
          ...
          <div className='row'>
            <div className='col-12 px-md-0 px-2'>
              <ul className="nav nav-tabs category-nav-tabs mb-3 pb-2">
                {data.subcategory_data && Object.keys(data.subcategory_data).length > 0 && 
                  Object.keys(data.subcategory_data).map((subCategoryKey, index, array) => (
                    <li
                      className={index === array.length - 1 ? "" : "nav-tabs-right"}
                      key={subCategoryKey}
                    >
                      <span
          ...
          <div className="tab-content">
            {data.subcategory_data && Object.keys(data.subcategory_data).length > 0 &&  Object.keys(data.subcategory_data).map((subCategoryKey) => (
              <div
                ...
                <div className="row">
                  {/* First Section Start */}
                    <div className="col-md-6 ps-md-4 pe-md-2 pt-md-1">
                      {/* 1st part start */}
                      {data.subcategory_data[subCategoryKey].slice(0, 1).map((item, index) => (
                        <div>
                          <Link href={item.URL}>
                            <div className="position-relative">
                              ...
                              {item.story_label != '' && (
                                <span className="img-story-label-position-category">{item.story_label}</span>
                              )}
                      ...
                      {/* 1st part End */}
                      {/* 2nd part Start */}
                      {data.subcategory_data[subCategoryKey].slice(1, 4).map((item, index) => (
                      ...
                      {/* 2nd part End */}
                      {/* 3rd part Start*/}
                      {data.keywords[subCategoryKey] && data.keywords[subCategoryKey].length > 0 && (
                  ...
                  <div className="col-md-6 position-relative">
                    {data.subcategory_data[subCategoryKey].slice(4, 14).map((item, index) => (
                    <div className="row row-height-position">
                      <div className="col-9 mb-3 mb-md-0">
                        ...
                        <Link href={item.URL}>
                          ...
                          >
                            {item.ispaid === 'Y' && (
                            <img src="https://www.mid-day.com/assets/images/md-premium.png" className="md-premium-small"/>
                            )}
                            {item.Homeheadline}
                          </h2>
                        </Link>
        ...
        <div className='col-md-3 rhselement pt-2'>
          ...
          <div className='row'>
            <div className='col-md-12'>
              <p className="advertisement-text text-center mt-1 mt-md-4 pt-md-3 mb-0">ADVERTISEMENT</p>
              ...
              <div className='row'>
                  ...
                  <div className='col-md-12'>
                      <div className="border text-center p-3">
                          <p className={homecss.categoryquizepera}>{data.rhs_data[0].Homeheadline}</p>
                          {/* <p className={homecss.categoryquizepera}>you know of Mumbai's</p>
                          <p className={homecss.categoryquizepera}>LGBTQIA+ legacy?</p> */}
                          <Link href={data.rhs_data[0].URL}><button className={homecss.categoryplaynow}>Play Now</button></Link>
                      </div>
                  </div>
              </div>
             )}
