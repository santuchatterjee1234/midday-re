...
export default function tagwisevideo({ categoryId, videoTagName }) {
    ...
    return ( 
        <>
        {data && data['video_tagwise_data'] && data['video_tagwise_data'].length > 0 && (
        <div className="row">
            ...
            <div className="row pb-3">
                {data['video_tagwise_data'] &&
                data['video_tagwise_data'].length > 0 &&
                data['video_tagwise_data'].map((item, index) => (
